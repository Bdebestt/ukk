        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($foto)){
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    ...
                    $sql="insert into petugas (kode_petugas,nama_petugas,nipp,jkk,emaill,no_telpp,alamatt,fotoo) values
                    ('$kode_petugas','$nama','$nipp','$jkk','$emaill','$no_telpp','$alamatt','$fotoo')";
                }
            }else {
                //Sql jika tidak menggunakan foto, maka akan memakai gambar_default.png
                $fotoo="foto_default.png";
                $sql="insert into petugas (kode_petugas,nama_petugas,nipp,jkk,emaill,no_telpp,alamatt,fotoo) values
                ('$kode_petugas','$nama','$nipp','$jkk','$emaill','$no_telpp','$alamatt','$fotoo')";
            }
...
<?php
    ...
    $tahun=date('y');
    $kode_depan = $tahun.'02';
    $nipp = $kode_depan . sprintf("%03s", $id_petugas);
