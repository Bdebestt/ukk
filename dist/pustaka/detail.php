        ...
        <div class="col-sm-6">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td>Rating</td>
                        <td width="78%">: <?php echo $data['rating'];?></td>
                    </tr>
                    <tr>
                        <td>Deskripsi</td>
                    ...
                    <tr>
                        <td colspan="2">  
                            ...
                            <a href="index.php?page=keranjang&kode_pustaka=<?php echo $data['kode_pustaka']; ?>&aksi=pilih_pustaka"  class="btn btn-dark btn-block"> Tambah Favorit</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endif; ?>
