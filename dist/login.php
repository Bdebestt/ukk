<?php
    ...
    if ($petugas>0){
        ...
        if ($row["status"]==1){
            ...
            header("Location:index.php?page=pustaka");
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                     ...
                                     <div class="card-body">
                                        ...
                                        <h3 class="text-center font-weight-bold my-4">ETIQUETTE</h3>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Etiquette</div>
                        </div>
                    </div>
                </footer>
            </div>
